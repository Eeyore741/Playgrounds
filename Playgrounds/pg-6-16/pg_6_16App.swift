...
fileprivate protocol BooksProider: Actor {
...
fileprivate actor LocalBooksProvider: BooksProider {
...
@MainActor
fileprivate final class BooksViewModel: ObservableObject {
...
@main
fileprivate struct pg_6_16App: App {
